...
///
/// **Note**
/// 如需最新数据，需从服务器获取：[ChatRoomManager.fetchChatRoomInfoFromServer]。
/// ~end
class ChatRoom {
  ChatRoom._private({
  ...
  ///
  /// **Note**
  /// 如需最新数据，需从服务器获取：[ChatRoomManager.fetchChatRoomMembers]。
  /// ~end
  ...
  ///
  /// **Note**
  /// 如果需要获取最新值，请调用：[ChatRoomManager.fetchChatRoomBlockList]。
  /// ~end
  ...
  ///
  /// **Note**
  /// 如果需要获取最新值，请调用 [ChatRoomManager.fetchChatRoomMuteList]。
  /// ~end
  ...
  ///
  /// **Note**
  /// 如果需要获取最新值，请调用 [ChatRoomManager.fetchChatRoomInfoFromServer]。
  /// ~end
