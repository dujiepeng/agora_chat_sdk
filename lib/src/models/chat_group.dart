...
class ChatGroup {
  ...
  ///
  /// **Note**
  /// 如需最新数据，需先从服务器获取：[ChatGroupManager.fetchMemberListFromServer]。
  ///
  /// **Return** 群组成员列表。
  /// ~end
  ...
  ///
  /// **Note**
  /// 如需最新数据，需先从服务器获取：[ChatGroupManager.fetchBlockListFromServer]。
  ///
  /// 只有群主和管理员可以调用该方法。
  ///
  /// **Return** 群组黑名单。
  ...
  ///
  /// **Note**
  /// 如需最新数据，需先从服务器获取：[ChatGroupManager.fetchMuteListFromServer]。
  ///
  /// **Return** 群组禁言名单。
  /// ~end
